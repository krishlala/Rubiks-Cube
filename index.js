...
!function () {
            var DIST_DRAG = 30, HINT_DELAY = 500,
            ...
            function playAnimation(r1, r2, r3, f1, f2) {
                ...
                if (r1 && r2)
                    ...
                    if (face) for (i = 0, len = face.length; i < len; ++i)
            ...
            function rollFace(f, str) {
                ...
                if (str == 180 || str == -180) {
                    t0 = f[0].xxc; t1 = f[1].xxc; t2 = f[2].xxc;
                    c0 = f[8].xxc; c1 = f[7].xxc; c2 = f[6].xxc;
                    f[0].classList.remove(t0); f[1].classList.remove(t1); f[2].classList.remove(t2);
                    f[8].classList.remove(c0); f[7].classList.remove(c1); f[6].classList.remove(c2);
                    f[0].classList.add(c0); f[1].classList.add(c1); f[2].classList.add(c2);
                    f[8].classList.add(t0); f[7].classList.add(t1); f[6].classList.add(t2);
                    f[0].xxc = c0; f[1].xxc = c1; f[2].xxc = c2;
                    f[8].xxc = t0; f[7].xxc = t1; f[6].xxc = t2;

                    t0 = f[3].xxc; c0 = f[5].xxc;
                    f[3].classList.remove(t0); f[3].classList.add(c0);
                    f[5].classList.remove(c0); f[5].classList.add(t0);
                    f[3].xxc = c0; f[5].xxc = t0;
                } else if (str == 90 || str == -270) {
                    t0 = f[0].xxc; t1 = f[1].xxc;
                    f[0].classList.remove(t0); f[1].classList.remove(t1);

                    c0 = f[6].xxc; c1 = f[3].xxc;
                    f[6].classList.remove(c0); f[3].classList.remove(c1);
                    f[0].classList.add(c0); f[1].classList.add(c1);
                    f[0].xxc = c0; f[1].xxc = c1;

                    c0 = f[8].xxc; c1 = f[7].xxc;
                    f[8].classList.remove(c0); f[7].classList.remove(c1);
                    f[6].classList.add(c0); f[3].classList.add(c1);
                    f[6].xxc = c0; f[3].xxc = c1;

                    c0 = f[2].xxc; c1 = f[5].xxc;
                    f[2].classList.remove(c0); f[5].classList.remove(c1);
                    f[8].classList.add(c0); f[7].classList.add(c1);
                    f[8].xxc = c0; f[7].xxc = c1;

                    f[2].classList.add(t0); f[5].classList.add(t1);
                    f[2].xxc = t0; f[5].xxc = t1;
                } else if (str == -90 || str == 270) {
                    t0 = f[0].xxc; t1 = f[1].xxc;
                    f[0].classList.remove(t0); f[1].classList.remove(t1);
                    ...
                    c0 = f[8].xxc; c1 = f[7].xxc;
                    f[8].classList.remove(c0); f[7].classList.remove(c1);
                    f[2].classList.add(c0); f[5].classList.add(c1);
                    f[2].xxc = c0; f[5].xxc = c1;
                    ...
                    f[6].classList.add(t0); f[3].classList.add(t1);
                    f[6].xxc = t0; f[3].xxc = t1;
                }
            }
            ...
            function rollRow(row, str) {
                ...
                if (str == 90 || str == -270) {
                    p0 = row[0][0]; p1 = row[0][1]; p2 = row[0][2];
                    c0 = p0.xxc; c1 = p1.xxc; c2 = p2.xxc;
                    p0.classList.toggle(c0); p1.classList.toggle(c1); p2.classList.toggle(c2);

                    p3 = row[1][0]; p4 = row[1][1]; p5 = row[1][2];
                    change();

                    p0 = p3; p1 = p4; p2 = p5;
                    p3 = row[2][0]; p4 = row[2][1]; p5 = row[2][2];
                    change();

                    p0 = p3; p1 = p4; p2 = p5;
                    p3 = row[3][0]; p4 = row[3][1]; p5 = row[3][2];
                    change();

                    p3.classList.toggle(c0); p4.classList.toggle(c1); p5.classList.toggle(c2);
                    p3.xxc = c0; p4.xxc = c1; p5.xxc = c2;
                    ...
                    p0 = row[1][0]; p1 = row[1][1]; p2 = row[1][2];
                    p3 = row[3][0]; p4 = row[3][1]; p5 = row[3][2];
                    swap();
                ...
                function change() {
                    c3 = p3.xxc; c4 = p4.xxc; c5 = p5.xxc;
                    p0.classList.toggle(c3); p1.classList.toggle(c4); p2.classList.toggle(c5);
                    p0.xxc = c3; p1.xxc = c4; p2.xxc = c5;
                    p3.classList.toggle(c3); p4.classList.toggle(c4); p5.classList.toggle(c5);
                }
